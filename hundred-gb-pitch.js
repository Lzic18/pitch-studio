...
replies.forEach(([title,text],i)=>{
 ...
 const body=document.createElement('p');body.className='hundred-gb-reply-text';const pattern=/(100GB of data for (?:just|only) £10 a month|£10 a month|£2 monthly discount on your broadband|£2 back through the saving on your broadband|£8)/g;
