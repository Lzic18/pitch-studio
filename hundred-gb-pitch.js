...
section.innerHTML='<div class="hundred-gb-heading"><div><h1 id="hundred-gb-title">100GB for £10 pitch</h1><p>Choose a pitch and copy it straight into your chat.</p></div><span class="hundred-gb-count">4 pitches</span></div><p id="hundred-gb-copy-status" class="hundred-gb-status" role="status" aria-live="polite"></p><div class="hundred-gb-grid"></div>';
...
replies.forEach(([title,text],i)=>{
 ...
 const body=document.createElement('p');body.className='hundred-gb-reply-text';const pattern=/(100GB of data for (?:just|only) £10 a month|£10 a month|£2 monthly discount on your broadband|£2 back through the saving on your broadband|£8|May I ask your thoughts on this\?)/g;
